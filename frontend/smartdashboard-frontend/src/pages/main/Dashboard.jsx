...
export default function Dashboard() {
  ...
  // Demo “system version” and “system parameters” (replace later with real API)
  ...
  const exportPDF = async () => {
    // Export only the dashboard content area (not entire body)
      ...
      <div className="app-shell">
        <div className="main">
          <div className="card">
            ...
            <p style={{ color: "#bcd3ff" }}>
              No active folder found. Please upload data or select a folder.
            </p>
  ...
  return (
    <div className="app-shell">
      <div className="main" id="dashboard-root">
